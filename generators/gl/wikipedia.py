...
class GalipediaLocalidadesGenerator(GalipediaGenerator):
    ...
    def __init__(self, countryName, categoryNames=[u"Cidades de {name}"],
        ...
        pattern = u"(Alcaldes|Arquitectura|Capitais|Comunas|Concellos|" \
            u"Festas?|Imaxes|Igrexa|Galería|Historia|Listas?|Localidades|" \
            u"Lugares|Municipios|Parroquias|Principais cidades) "
        categoryBrowser = CategoryBrowser(
            categoryNames=parsedCategoryNames,
            invalidPagePattern=u"(?i)^(Wikipedia:|{pattern}[a-z])".format(
                pattern=pattern),
            validCategoryPattern=u"(?i)^(Antig[ao]s )?(Cidades|Comunas|"
            u"Concellos|Municipios|Parroquias|Vilas) ",
            invalidCategoryAsPagePattern=u"(?i){pattern}[a-z]|.+"
            u"sen imaxes$".format(pattern=pattern),
        )
        ...
        super(GalipediaLocalidadesGenerator, self).__init__(
            resource=u"onomástica/toponimia/localidades/{name}.dic".format(
                name=countryName.lower().replace(" ", "-")),
...
class GalipediaRexionsGenerator(GalipediaGenerator):
    ...
    def __init__(self, countryName, categoryNames=[u"Rexións de {name}"],
        ...
        categoryPattern = u"Áreas municipais|Comarcas|Condados|" \
            u"Departamentos|Distritos|Divisións|Estados|Partidos xudiciais|" \
            u"Periferias|Provincias|Repúblicas|Rexións|Subdivisións|" \
            u"Subrexións"
        categoryBrowser = CategoryBrowser(
            categoryNames=parsedCategoryNames,
            invalidPagePattern=u"^((Batalla|Lista|{}) |"
            u"Comunidade autónoma)".format(categoryPattern),
            validCategoryPattern=u"^({}) ".format(categoryPattern),
            invalidCategoryAsPagePattern=u"^(Capitais|Categorías|Concellos|"
            u"Deporte|Gobernos|Nados|Parlamentos|Personalidades|"
            u"Políticas|Presidentes) ",
        )

        super(GalipediaRexionsGenerator, self).__init__(
            resource=u"onomástica/toponimia/rexións/{name}.dic".format(
                name=countryName.lower().replace(" ", "-")),
            partOfSpeech=u"topónimo",
            entryGenerators=[
                EntryGenerator(
...
class GalipediaNamesGenerator(GalipediaGenerator):
    ...
    def __init__(self):
        ...
        pageNames = [u"Lista de nomes masculinos en galego",
                     u"Lista de nomes femininos en galego"]
...
def generators():
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        invalidPagePattern=u"^(Imaxes |Listas |Premio |"
                        u"{})".format(pattern),
    ...
    pattern = u"Biólogos|Bioquímicos|Científicos|Empresarios|Farmacéuticos|" \
        u"Físicos|Matemáticos|Médicos|Personalidades|Químicos"
    generators.append(GalipediaGenerator(
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        invalidPagePattern=u"^(Día do Científico|Imaxes |"
                        u"Premio |{})".format(pattern),
                        validCategoryPattern=u"^({})".format(pattern),
                    ),
                ],
                pageParser=FirstSentenceParser(),
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        invalidPagePattern=u"^(Dinastía|Imaxes de|Lista d|"
                        u"Xeración)",
                        validCategoryPattern=u"^(Dinastía|Escritores|"
                        u"Poetas|Tradutores|Reis|Xeración)",
    ...
    pattern = u"Chanceleres|Personalidades|Políticos|"\
        u"Presidente do Consello de Comisarios do Pobo|Presidentes|" \
        u"Primeiros [Mm]inistros|Secretarios|Taoiseach"
    generators.append(GalipediaGenerator(
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        invalidPagePattern=u"^(Imaxes |Premio |{})".format(
                            pattern),
                        validCategoryPattern=u"^({})".format(pattern),
                    ),
                ],
    ...
    pattern = u"(Arquitectura relixiosa|Basílicas|Capelas|Catedrais|" \
        u"Colexiatas|Conventos|Ermidas|Igrexas|Mosteiros|" \
        u"Mosteiros e conventos|Pórticos|Santuarios|Templos) "
    generators.append(GalipediaGenerator(
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        invalidPagePattern=u"^({pattern}|Galería de imaxes|"
                        u"Iglesias gallegas de la Edad Media$)".format(
                            pattern=pattern),
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        invalidPagePattern=u"^(Lista d|Planeta anano$|"
                        u"Planeta($| ))",
                        validCategoryPattern=u"^(Candidatos a planeta|"
                        u"Planetas |Plutoides$)",
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        validCategoryPattern=u"^(Acontecementos|Campionatos|"
                        u"Competicións|Ligas|Mundiais|Torneos)",
                        invalidCategoryAsPagePattern=u"(^(Balóns|Goleadores|"
                        u"Tempadas)|.* nos Xogos Olímpicos$)",
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        invalidPagePattern=u"^(Banca ética|Banco malo|"
                        u"Caixa de aforros|Caixeiro automático)$",
                ...
                pageGenerators=[
                    CategoryBrowser(
                        categoryOfPagesNames=[
                            u"Empresas de telecomunicacións"],
                    ),
                ],
                pageParser=FirstSentenceParser(),
            )
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        # Ignorados, polos menos de momento.
                        invalidCategoryAsPagePattern=u"^(Catástrofes|"
                        u"Conflitos|Declaracións de independencia|"
                        u"Guerras|Revolucións)",
                    ),
                ],
                pageParser=FirstSentenceParser(),
            )
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        invalidPagePattern=u"^((Lista|Pobos) |(Civilización|"
                        u"Cultura dos Campos de Urnas|Sala do hidromel)$)",
                        validCategoryPattern=u"^(Pobos|Reinos) ",
                        invalidCategoryAsPagePattern=u"^(Arquitectura|"
                        u"Xeografía) ",
                    ),
                ],
                pageParser=FirstSentenceParser(),
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        invalidPagePattern=u"^(Imaxes |Listas |Exemplos |"
                        u"Linguaxe compilada|Linguaxe de alto nivel|"
                        u"Linguaxe de programación$|"
                        u"Linguaxe interpretada|{})".format(pattern),
                        validCategoryPattern=u"^({})".format(pattern),
                    ),
                ],
                pageParser=FirstSentenceParser(),
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        invalidPagePattern=u"^(Imaxes |Listas |(Rede social|"
                        u"Blogueiros)$|{})".format(pattern),
                        validCategoryPattern=u"^({})".format(pattern),
    ...
    pattern = u"Ambientes de escritorio|Aplicacións|Compañías|" \
        u"Conxuntos de aplicacións|Editores|Emuladores|Follas|Kernels|" \
        u"Navegadores|Personaxes|Procesadores|Reprodutores|Servidores|" \
        u"Sistemas operativos|Software|Utilidades|Videoxogos|Xestores"
    generators.append(GalipediaGenerator(
        ...
        entryGenerators=[
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        categoryNames=[
                            u"Software móbil", u"Software por tipo"],
                        invalidPagePattern=u"^(Imaxes |Listas |Premio |"
                        u"Navegador web|Videoxogo|{})".format(pattern),
                        validCategoryPattern=u"^({})".format(pattern),
                    ),
                ],
                pageParser=FirstSentenceParser(),
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        validCategoryPattern=u"^(Acontecementos|Festivais|"
                        u"Xiras)",
                    ),
                ],
                pageParser=FirstSentenceParser(),
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        invalidPagePattern=u"^(Colectivo|Gremio|"
                        u"Organización non gobernamental)$",
                        validCategoryPattern=u"^(Asociacións|Bandas|Centros|"
                        u"Corais|Entidades|Fundacións|Organizacións|"
                        u"Orquestras|Sindicatos)",
                    ),
                ],
                pageParser=FirstSentenceParser(),
            )
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        validCategoryPattern=u"^(Autoridades|Federacións|"
                        u"Organismos|Organizacións)",
                    ),
                ],
                pageParser=FirstSentenceParser(),
            )
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        invalidPagePattern=u"^(Cadea de televisión|"
                        u"Televisión comunitaria)$",
                    ),
                ],
                pageParser=FirstSentenceParser(),
            )
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        invalidPagePattern=u"^((Batalla|Lista) |"
                        u"Illa deserta|Illote Motu|Illas de Galicia)",
                        invalidCategoryAsPagePattern=u"^(Illas da baía d.*|"
                        u"Illas do arquipélago d.*|Illas do Xapón|"
                        u"Illas e arquipélagos .*)$",
                        categoryOfCategoriesNames=[
                            u"Illas e arquipélagos por localización",
                            u"Illas por continente", u"Illas por mar",
                            u"Illas por países"],
                    ),
                ],
                pageParser=FirstSentenceParser(),
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        invalidPagePattern=u"^(Instituto|(Mar|"
                        u"Océano mundial|Zona económica exclusiva)$)",
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        validCategoryPattern=u"^(Cordilleiras|Cumes|"
                        u"Montañas|Montes)",
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        invalidPagePattern=u"^({pattern}|Bandeira Azul$|"
                        u"Galería de imaxes|Praia$|"
                        u"Praia nudista$)".format(pattern=pattern),
                        validCategoryPattern=u"^{pattern}".format(
                            pattern=pattern),
                        invalidCategoryAsPagePattern=u"^(Imaxes) ",
                    ),
        ...
        entryGenerators=[
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        invalidPagePattern=u"^({pattern}|(Galería de imaxes|"
                        u"Hidrografía|Lista) |(Caneiro \(muíño\)|"
                        u"Pasadoiro|Pontella \(pasaxe\))$)".format(
                            pattern=pattern),
                        validCategoryPattern=u"^{pattern}".format(
                            pattern=pattern),
                        invalidCategoryAsPagePattern=u"^({pattern}|"
                        u"Imaxes)".format(pattern=pattern),
    ...
    generators.append(GalipediaLocalidadesGenerator(
        u"Desaparecidas", [u"Cidades desaparecidas"]))
    generators.append(GalipediaLocalidadesGenerator(
        u"Alemaña", pageParser=FirstSentenceParser()))
    generators.append(GalipediaLocalidadesGenerator(u"Alxeria"))
    generators.append(GalipediaLocalidadesGenerator(
        u"Austria", pageParser=FirstSentenceParser()))
    generators.append(GalipediaLocalidadesGenerator(u"Bangladesh"))
    generators.append(GalipediaLocalidadesGenerator(u"Barbados"))
    generators.append(GalipediaLocalidadesGenerator(
        u"Bélxica", pageParser=FirstSentenceParser()))
    generators.append(GalipediaLocalidadesGenerator(u"Bolivia"))
    generators.append(
        GalipediaLocalidadesGenerator(u"Brasil", [u"Cidades do {name}"]))
    generators.append(GalipediaLocalidadesGenerator(
        u"Burkina Faso", pageParser=FirstSentenceParser()))
    generators.append(GalipediaLocalidadesGenerator(
        u"Cambodja", pageParser=FirstSentenceParser()))
    generators.append(GalipediaLocalidadesGenerator(
        u"Canadá", [u"Cidades do {name}"], pageParser=FirstSentenceParser()))
    generators.append(GalipediaLocalidadesGenerator(
        u"China", [u"Cidades da {name}"], pageParser=FirstSentenceParser()))
    generators.append(GalipediaLocalidadesGenerator(u"Colombia", [
                      u"Cidades de {name}", u"Concellos de {name}",
                      u"Correxementos de {name}"]))
    generators.append(GalipediaLocalidadesGenerator(
        u"Congo", [u"Cidades da República do {name}"]))
    generators.append(GalipediaLocalidadesGenerator(
        u"Corea do Norte", pageParser=FirstSentenceParser()))
    generators.append(GalipediaLocalidadesGenerator(u"Cuba"))
    generators.append(GalipediaLocalidadesGenerator(u"Dinamarca"))
    generators.append(GalipediaLocalidadesGenerator(
        u"Dominica", pageParser=FirstSentenceParser()))
    generators.append(GalipediaLocalidadesGenerator(
    ...
    generators.append(GalipediaLocalidadesGenerator(
        u"España",
        [u"Cidades autónomas de {name}", u"Cidades de {name}",
         u"Concellos de {name}", u"Parroquias de España"],
        pageParser=FirstSentenceParser()))
    generators.append(GalipediaLocalidadesGenerator(
        u"Estados Unidos de América", [u"Cidades dos {name}"]))
    generators.append(GalipediaLocalidadesGenerator(u"Etiopía"))
    generators.append(GalipediaLocalidadesGenerator(u"Exipto"))
    generators.append(GalipediaLocalidadesGenerator(
        u"Finlandia", pageParser=FirstSentenceParser()))
    generators.append(GalipediaLocalidadesGenerator(
        u"Francia", [u"Cidades de {name}", u"Concellos de {name}"]))
    generators.append(GalipediaLocalidadesGenerator(
        u"Grecia", pageParser=FirstSentenceParser()))
    generators.append(GalipediaLocalidadesGenerator(
        u"Grecia antiga", [u"Antigas cidades gregas"]))
    generators.append(GalipediaLocalidadesGenerator(
        u"Guatemala", [u"Cidades de {name}", u"Municipios de {name}"]))
    ...
    generators.append(
        GalipediaLocalidadesGenerator(u"India", [u"Cidades da {name}"]))
    ...
    generators.append(GalipediaLocalidadesGenerator(
        u"Islandia", pageParser=FirstSentenceParser()))
    generators.append(GalipediaLocalidadesGenerator(u"Israel"))
    generators.append(GalipediaLocalidadesGenerator(
        u"Italia", [u"Cidades de {name}", u"Concellos de {name}"]))
    generators.append(GalipediaLocalidadesGenerator(
        u"Kenya", pageParser=FirstSentenceParser()))
    generators.append(
        GalipediaLocalidadesGenerator(u"Líbano", [u"Cidades do {name}"]))
    generators.append(GalipediaLocalidadesGenerator(u"Malaisia"))
    generators.append(GalipediaLocalidadesGenerator(u"Malí"))
    generators.append(GalipediaLocalidadesGenerator(
        u"Marrocos", pageParser=FirstSentenceParser()))
    generators.append(GalipediaLocalidadesGenerator(u"México", [
                      u"Cidades de {name}", u"Cidades prehispánicas de {name}",
                      u"Concellos de {name}"]))
    generators.append(GalipediaLocalidadesGenerator(
        u"Mozambique", pageParser=FirstSentenceParser()))
    generators.append(
        GalipediaLocalidadesGenerator(u"Nepal", [u"Cidades do {name}"]))
    generators.append(GalipediaLocalidadesGenerator(u"Oceanía"))
    generators.append(
        GalipediaLocalidadesGenerator(u"Omán",
                                      pageParser=FirstSentenceParser()))
    generators.append(
        GalipediaLocalidadesGenerator(u"Países Baixos",
                                      [u"Cidades dos {name}"]))
    generators.append(GalipediaLocalidadesGenerator(u"Paquistán"))
    generators.append(
        GalipediaLocalidadesGenerator(u"Perú", [u"Cidades do {name}"]))
    generators.append(GalipediaLocalidadesGenerator(u"Polonia"))
    generators.append(GalipediaLocalidadesGenerator(
        u"Portugal", [u"Cidades de {name}", u"Municipios de {name}",
                      u"Vilas de {name}"]))
    generators.append(GalipediaLocalidadesGenerator(u"Qatar"))
    generators.append(
        GalipediaLocalidadesGenerator(u"Reino Unido", [u"Cidades do {name}"]))
    generators.append(GalipediaLocalidadesGenerator(u"Romanía"))
    generators.append(GalipediaLocalidadesGenerator(
        u"Rusia", pageParser=FirstSentenceParser()))
    ...
    generators.append(GalipediaLocalidadesGenerator(
        u"Ucraína", pageParser=FirstSentenceParser()))
    generators.append(GalipediaLocalidadesGenerator(u"Venezuela"))
    generators.append(GalipediaLocalidadesGenerator(
        u"Xapón", [u"Concellos do {name}"], pageParser=FirstSentenceParser()))
        ...
        entryGenerators=[
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        categoryNames=[
                            u"Lugares de Galicia", u"Parroquias de Galicia"],
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        invalidPagePattern=u"^(Concellos |Galería d|"
                        u"Historia d|Lista d|Principais cidades )",
                        validCategoryPattern=u"^(Estados desaparecidos d|"
                        u"Imperios|Países d)",
                        invalidCategoryAsPagePattern=u"^(Capitais d|"
                        u"Emperadores$)",
                    ),
                ],
                pageParser=FirstSentenceParser(),
    ...
    generators.append(GalipediaRexionsGenerator(
        u"Alemaña", [u"Estados de {name}", u"Rexións de {name}"]))
    generators.append(GalipediaRexionsGenerator(
        u"Bélxica",
        [u"Provincias da {name}", u"Rexións de {name}"],
        pageParser=FirstSentenceParser()))
    generators.append(
        GalipediaRexionsGenerator(u"Brasil", [u"Estados do {name}"]))
    generators.append(GalipediaRexionsGenerator(u"Chile"))
    generators.append(GalipediaRexionsGenerator(
        u"Colombia", [u"Departamentos de {name}", u"Provincias de {name}"]))
    generators.append(GalipediaRexionsGenerator(
        u"España",
        [u"Comarcas de {name}", u"Comunidades autónomas de {name}",
         u"Provincias de {name}"]))
    generators.append(GalipediaRexionsGenerator(
        u"Estados Unidos de América",
        [u"Estados dos {name}", u"Distritos de Nova York"]))
    generators.append(GalipediaRexionsGenerator(u"Finlandia"))
    generators.append(
        GalipediaRexionsGenerator(u"Francia", [u"Departamentos de {name}"]))
    generators.append(
        GalipediaRexionsGenerator(u"Grecia", [u"Periferias de {name}"]))
    generators.append(
        GalipediaRexionsGenerator(u"Guatemala", [u"Departamentos de {name}"]))
    generators.append(
        GalipediaRexionsGenerator(u"India", [u"Subdivisións da {name}"]))
    generators.append(GalipediaRexionsGenerator(
        u"Italia", [u"Rexións de {name}", u"Provincias de {name}"]))
    generators.append(
        GalipediaRexionsGenerator(u"México", [u"Estados de {name}"]))
    generators.append(
        GalipediaRexionsGenerator(u"Países Baixos",
                                  [u"Provincias dos {name}"]))
    ...
    generators.append(GalipediaRexionsGenerator(
        u"Reino Unido",
        [u"Condados de Inglaterra", u"Condados de Irlanda",
         u"Divisións de Escocia", u"Rexións de Inglaterra"]))
    generators.append(
        GalipediaRexionsGenerator(u"Rusia", [u"Repúblicas de {name}"]))
        ...
        entryGenerators=[
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        categoryNames=[
                            u"Barrios de España", u"Distritos de España"],
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        invalidPagePattern=u"^(Babor|Barco|Calado|"
                        u"Desprazamento \(náutica\)|Estribor|Francobordo|"
                        u"Navegación marítima|Popa|Proa|Puntal)$",
                        validCategoryPattern=u"^(Barcos|Embarcacións)",
                        invalidCategoryAsPagePattern=u"^(Accidentes|Imaxes|"
                        u"Tipos)",
                    ),
                ],
                pageParser=FirstSentenceParser(),
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        invalidPagePattern=u"^(Aeroliña|"
                        u"Aeroliña de baixo custo)$",
        ...
        entryGenerators=[
            EntryGenerator(
                pageGenerators=[
                    PageLoader(
                        pageNames=[
                            u"Lista de siglas e acrónimos de alimentación"
                        ],),
                ],
        ...
        entryGenerators=[
            EntryGenerator(
                pageGenerators=[
                    PageLoader(
                        pageNames=[
                            u"Lista de siglas e acrónimos de informática"
                        ],),
                ],
                pageParser=LineParser(lineExpression),
            ),
    ...
    generators.append(GalipediaGenerator(
        ...
        entryGenerators=[
            EntryGenerator(
                pageGenerators=[
                    PageLoader(
                        pageNames=[u"Lista de acrónimos en Medicina", ],),
                ],
                pageParser=LineParser(lineExpression),
            )
        ],
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        invalidPagePattern=u"^(Compañía de seguros|"
                        u"Reaseguro|Sector asegurador en España)$",
            ...
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        ...
                        validCategoryPattern=u"^(Members|Musicians|People|"
                        u"Singers) ",
                    ),
                ],
            )
        ...
        entryGenerators=[
            EntryGenerator(
                pageGenerators=[
                    CategoryBrowser(
                        categoryOfCategoriesNames=[
                            u"Férfikeresztnevek", u"Női keresztnevek"],
                    ),
                ],
            )
        ],
