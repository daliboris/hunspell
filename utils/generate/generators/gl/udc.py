...
languageUsageCriteria2012PdfUrl = u"http://www.udc.es/snl/documentospdf/" \
    u"Libro_Criterios_lingua.pdf"
languageUsageCriteria2007PdfUrl = u"http://www.concellodezas.org/linguazas/" \
...
class AcronymsGenerator(generator.Generator):
    ...
    def generateFileContent(self):
        ...
        parsingStage = 0
        entry = None
        twoLineEntries = [u"CGENDL", u"CIXTEC", u"CORDIS", u"ECTS",
                          u"EFQM", u"FAO", u"ISBN", u"ISO", u"ISSN", u"Unesco",
                          "Unicef"]
        ...
        for line in pdfParser.lines():
            ...
            if parsingStage == 0:
                if line == u"ANEXO IV. RELACIÓN DE SIGLAS E ACRÓNIMOS " \
                        u"MÁIS HABITUAIS":
                    parsingStage += 1
                continue
            ...
            if line in [u"CRITERIOS PARA O USO DA LINGUA", u"ANEXO IV. "
...
class UdcAcronymsGenerator(generator.Generator):
    ...
    def generateFileContent(self):
        ...
        for line in pdfParser.lines():
            ...
            if line in [u"CRITERIOS PARA O USO DA LINGUA", u"ANEXO V. "
                        u"RELACIÓN DE SIGLAS E ACRÓNIMOS MÁIS HABITUAIS "
                        u"DA UDC"]:
                continue
            if line.isdigit():
